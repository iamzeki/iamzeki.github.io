!function (a, b, c) {
    ...
    function f(b, c, d, e, f) {
        if (b && c && d) {
            var g, h, i, j, k = b + "://" + c + "/" + d;
            if (e = e || [], !f || !O[f] && !window[f])for (f = null, h = 0, i = e.length; i > h; h++)if (g = e[h], a.isObject(g) && (g = g.callbackName || g.callback), g && (O[g] || window[g])) {
                f = g;
                break
            }
            f && (P[f] = {
    ...
    function k(d, f, g, h) {
        var i, k, l, m = a.isFunction(d) ? d : O[d] || window[d], n = Date.now();
    ...
    function A(a) {
        var b = "evt-" + a, c = O[b], d = F.call(arguments, 1);
    ...
    var C, D = navigator.userAgent, E = window.MQQfirebug, F = Array.prototype.slice, G = Object.prototype.toString, H = /\b(iPad|iPhone|iPod)\b.*? OS ([\d_]+)/, I = /\bAndroid([^;]+)/, J = /\bQQ\/([\d\.]+)/, K = /\bIPadQQ\/([\d\.]+).*?\bQQ\/([\d\.]+)/, L = /\bV1_AND_SQI?_([\d\.]+)(.*? QQ\/([\d\.]+))?/, M = /\bTBS\/([\d]+)/, N = /\bTribe\/([\d\.]+)/, O = a.__aCallbacks || {}, P = a.__aReports || {}, Q = a.__aSupports || {}, R = a.__aFunctions || {}, S = 1, T = -1e5, U = {
        qbizApi: "5.0",
        pay: "999999",
    ...
    }(), supportInvoke: !0, support: {ios: "5.9.5", android: "4.5"}
    ...
    var a = function (a) {
        ...
        if (mqq.compare("4.7.1") >= 0)mqq.invokeClient("qw_data", "getPerformance", a(b)); else try {
            ...
            b({result: -1, message: "璇ユ帴鍙ｅ湪鎵婹 v4.7.1 鎴栦互涓婃墠鏀寔锛�", data: null})
        }
    };
    ...
    iOS: function (a) {
        ...
        if (mqq.compare("4.6") >= 0) {
            ...
            mqq.__reportAPI("web", "device", "getClientInfo"), a({
                isMobileQQ: !0, systemName: "android", systemVersion: function (a) {
                    return a && a[1] || 0
    ...
    var a = function (a) {
        return function (b, c, d) {
            ...
            } else 1 === b || -1 === b ? (f.retmsg = "鐢ㄦ埛涓诲姩鏀惧純鏀粯", f.resultCode = -1) : f.retmsg = c;
            a && a(f)
        }
    };
    ...
    android: function (a) {
        var b = a.callback;
        b && (mqq.compare("7.1.5") < 0 ? b({result: 0}) : mqq.invokeClient("ui", "mobileDataDialog", {
            source: a.source,
            type: a.type,
            callback: mqq.callback(b)
        }))
        ...
        var b = a.callback;
        b && b({result: 0})
    }, supportInvoke: !0, support: {android: "4.2", iOS: "4.2"}
    ...
    iOS: function (a, b) {
        ...
        mqq.invokeClient("QQApi", "shareArkMessage", a, mqq.callback(b))
    }, supportInvoke: !0, support: {iOS: "7.2.5", android: "7.2.5"}
